...
\setmonofont[BoldFont={Andale Mono}]{Andale Mono}
\setCJKmainfont[
...
\tikzset{
  mark angle/.style n args={3}{    % deprecated
    draw=#1!50, fill=#1!20,
    angle radius=#2, angle eccentricity=#3,
  },
  opafill/.style n args={1}{       % deprecated
...
\newcommand\mathalignsep{\hspace{13pt}}  % deprecated
...
\newcommand\calclen[4]{sqrt((#1-#3)^2+(#2-#4)^2)} % deprecated
\newcommand\calcdotpos[3]{(#1+#3*(#2-#1))}        % deprecated
\newcommand\calcbisectorx[6]{\calcdotpos#1#5{     % deprecated
  \calclen#1#2#3#4/(\calclen#1#2#3#4+\calclen#3#4#5#6)}}
\newcommand\calcbisectory[6]{\calcdotpos#2#6{     % deprecated
  \calclen#1#2#3#4/(\calclen#1#2#3#4+\calclen#3#4#5#6)}}
