...
此问题集采用LaTeX编写，具体分为四卷，每卷64题。编篡此集旨在提升数学能力，与广大数学爱好者共享数学之乐趣。

## 文件组织

- **0000-003F.tex, ..., 00C0-00FF.tex**：主文件，每个文件包含一卷内容；
...
编译生成的.aux、.log、.toc、.fls、.xdv、.fdb_latexmk文件，以及probs/中的.aux文件都是中间文件，完成生成PDF后可直接舍弃。.synctex.gz文件若不需要，也可舍弃。

## 贡献与鸣谢

欢迎提交新问题、已知问题的新方法，或纠正已知问题的错误。欢迎向仓库提交PR。*在0093及以后的平面几何问题，为统一绘图格式，请不要再使用TikZ绘图，建议使用TkZ-Euclide。*

感谢JYH（0099之问题、009A之问题等）、LTY（000A之2个方法、00B0之问题等）、YCY（003F之1个方法等）、LHQ（0049之问题与1个方法等）、ZYT（00C0之问题等）、XWT（009D之1个方法等）等对编撰工作的支持。具体贡献情况参见CONTRIBUTORS.md。

## 注意事项

- 由于历史原因，部分问题（在problist清单之“解答未编写”题单中列出）尚未编写方法，部分问题或其方法的文本中存在排版问题；
